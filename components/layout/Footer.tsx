        ...
        <footer className="bg-background text-foreground pt-20 pb-10 border-t border-border transition-colors duration-500">
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed max-w-xs font-medium">
                            Turning ideas into impactful digital experiences. Expert web design and development company based in Erode and Coimbatore.
                        </p>
                        ...
                        <ul className="space-y-6 text-muted-foreground text-sm font-bold">
                            <li className="flex items-start">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <span className="text-foreground block mb-1 font-black text-xs uppercase tracking-widest">Erode Office:</span>
                                        <p className="leading-relaxed">Old .146, New No.8, Meenakshi Sundatam Street, Thirunagar Colony, Erode-638 003</p>
                                    </div>
                                    <div>
                                        <span className="text-foreground block mb-1 font-black text-xs uppercase tracking-widest">Coimbatore Office:</span>
                                        <p className="leading-relaxed">123, Avinashi Road, Peelamedu, Coimbatore - 641004</p>
                                    </div>
                                </div>
                            </li>
                            <li className="flex items-center">
                                <Mail className="mr-3 w-5 h-5 text-primary shrink-0" />
                                <a href="mailto:info@slashinfotech.com" className="hover:text-primary transition-colors">info@slashinfotech.com</a>
                            </li>
                            <li className="flex items-center">
                ...
                <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-muted-foreground text-[10px] sm:text-xs gap-4 uppercase tracking-[0.2em] font-black">
                    <p>Copyright © 2026 SLASH INFO TECH | All Rights Reserved</p>
