  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="mb-6 font-black leading-tight text-foreground text-3xl md:text-5xl tracking-tight uppercase animate-in fade-in slide-in-from-right duration-700">
                ...
                <span className="text-primary text-2xl md:text-4xl block mt-2">Development Services in Erode</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed animate-in fade-in slide-in-from-bottom duration-1000">
                At <strong>Ryan Quantum Technologies</strong>, we deliver high-quality and affordable web design and development solutions that drive measurable results. Based in <strong>Erode</strong>, we specialize in creating professional, mobile-responsive, and SEO-optimized websites that enhance your brand presence and business performance.
              </p>
      ...
      <CTASection
        ...
        description="Join hands with Ryan Quantum Technologies to transform your vision into a digital reality."
      />
    </>
  );
}
